...
public class GenericFormatterTests
{
    ...
    public void TestCustomStructRepr_NoToString()
    {
        ...
        Assert.Equal(expected: "Point(X: 10i32, Y: 20i32)", actual: point.Repr());
    }
    ...
    public void TestCustomStructRepr_WithToString()
    {
        ...
        Assert.Equal(expected: "CustomStruct(Name: \"test\", Value: 42i32)",
            actual: custom.Repr());
    }
    ...
    public void TestClassRepr_WithToString()
    {
        ...
        Assert.Equal(expected: "Person(Age: 30i32, Name: \"Alice\")", actual: person.Repr());
    }
    ...
    public void TestClassRepr_NoToString()
    {
        ...
        Assert.Equal(expected: "NoToStringClass(Data: \"data\", Number: 123i32)",
    ...
    public void TestRecordRepr()
    {
        ...
        Assert.Equal(
            "TestSettings({ EquipmentName: \"Printer\", EquipmentSettings: {\"Temp (C)\": 200f64, \"PrintSpeed (mm/s)\": 30f64} })",
            result);
    }
    ...
    {
        Assert.Equal(expected: "Colors.GREEN (1i32)", actual: Colors.GREEN.Repr());
    }
